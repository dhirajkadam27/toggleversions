...
function ToolVector() {
    ...
    }, [ShowSVGBackground,RectangleBackgroundRGB]);
  ...
  return (
    ...
    <div className="RectangleSize">
        ...
        <div className="Middle">
            ...
            <button className="Right"><span className="material-symbols-outlined">link</span></button>
    </div>
    ...
    <div className="RectangleMore">
        ...
        <span className="material-symbols-outlined">rounded_corner</span>
            ...
            <button className="Right"><span className="material-symbols-outlined">pageless</span></button>
    </div>
