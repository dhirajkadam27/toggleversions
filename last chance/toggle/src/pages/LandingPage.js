  ...
  return (
    <div className="LandingPage">
      ...
      <div className='tagline'>
        <div className='taglinetext'>We<img alt="UIUX" src="https://www.naapbooks.com/media/rzyffzgf/mobile_app_development_banner.jfif?width=700" />deliver</div>
        <div className='taglinetext'>technology that puts</div>
        <div className='taglinetext'>creators<img alt="UIUX" src="https://s29814.pcdn.co/wp-content/uploads/2023/04/shutterstock_2085604534.jpg.optimal.jpg" />first</div>
      </div>
