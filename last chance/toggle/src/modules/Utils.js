...
export const Provider = ({ children }) => {
  ...
  return (
    <Context.Provider value={{ layerwidth, setlayerwidth,propertieswidth, setpropertieswidth,   targets, setTargets,pages, setpages,layer, setLayer,activeTool, setActiveTool,zoom,setZoom,viewerRef,guidesHorizontal,guidesHorizontalR,guidesVertical,guidesVerticalB,moveableTriggers, SetMoveableTriggers,moveable,elementGuidelines,isMouseDown, setIsMouseDown,element, setElement }}>
      {children}
    </Context.Provider>
  );
};
